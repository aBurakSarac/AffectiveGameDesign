...
function Nav({ active, open, setOpen, onNav, links, onCustomize }) {
  ...
  return /* @__PURE__ */ React.createElement("nav", { className: "nav" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("a", { href: "#overview", className: "nav-brand", onClick: (e) => go(e, "overview") }, /* @__PURE__ */ React.createElement("span", { className: "rec-dot" }), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "bt" }, "La Fa\xE7ade ", /* @__PURE__ */ React.createElement("em", null, "Fissur\xE9e"))), /* @__PURE__ */ React.createElement("span", { className: "bs" }, "FER + rPPG")), /* @__PURE__ */ React.createElement("div", { className: `nav-links ${open ? "open" : ""}` }, links.map(([id, lab]) => /* @__PURE__ */ React.createElement("a", { key: id, href: `#${id}`, className: active === id ? "active" : "", onClick: (e) => go(e, id) }, lab)), /* @__PURE__ */ React.createElement("a", { href: "#player", className: "nav-cta", onClick: (e) => go(e, "player") }, "Open the HUD \u25B8")), /* @__PURE__ */ React.createElement("button", { className: "nav-custom", onClick: onCustomize, "aria-label": "Customize sections", title: "Reorder & hide sections" }, /* @__PURE__ */ React.createElement(Icon, { name: "sliders", s: 17 })), /* @__PURE__ */ React.createElement("button", { className: "nav-toggle", onClick: () => setOpen((o) => !o), "aria-label": "Menu" }, /* @__PURE__ */ React.createElement(Icon, { name: open ? "close" : "menu" }))));
}
function Hero({ onNav }) {
  const R = window.SITE.RESULTS;
  return /* @__PURE__ */ React.createElement("header", { className: "hero section-block", id: "overview" }, /* @__PURE__ */ React.createElement("div", { className: "hero-aura" }), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("span", { className: "hero-tag reveal" }, /* @__PURE__ */ React.createElement("span", { className: "pill" }, "Final project"), "Galatasaray University \xB7 Computer Engineering"), /* @__PURE__ */ React.createElement("h1", { className: "reveal" }, "Can a plain webcam", /* @__PURE__ */ React.createElement("br", null), "feel a player's ", /* @__PURE__ */ React.createElement("em", null, "fear"), "?"), /* @__PURE__ */ React.createElement("p", { className: "hero-sub reveal" }, "A real-time, privacy-preserving pipeline that fuses facial emotion recognition with a contactless heart rate read from skin colour \u2014 scoring fear under the dim, flickering light of horror games. Everything runs locally; no video ever leaves the device."), /* @__PURE__ */ React.createElement("div", { className: "hero-actions reveal" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: () => onNav("player") }, /* @__PURE__ */ React.createElement(Icon, { name: "play", s: 17 }), " Watch real sessions"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost", onClick: () => onNav("fusion") }, "Does the heartbeat help? ", /* @__PURE__ */ React.createElement(Icon, { name: "arrow", s: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "result-strip reveal" }, R.map((c) => /* @__PURE__ */ React.createElement("div", { key: c.k, className: `result-cell ${c.tone}` }, /* @__PURE__ */ React.createElement("div", { className: "rc-k" }, c.k), /* @__PURE__ */ React.createElement("div", { className: "rc-v" }, c.v, c.unit ? /* @__PURE__ */ React.createElement("small", null, c.unit) : null), /* @__PURE__ */ React.createElement("div", { className: "rc-s" }, c.s))))));
}
function PlayerVideo({ f, session, videoRef, sessionReady, onToggle }) {
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "video-overlay" }, faceStyle && /* @__PURE__ */ React.createElement("div", { className: "roi roi-face", style: faceStyle }, /* @__PURE__ */ React.createElement("span", { className: "roi-label" }, "FER \xB7 face ROI")), foreheadStyle && /* @__PURE__ */ React.createElement("div", { className: "roi roi-forehead", style: foreheadStyle }, /* @__PURE__ */ React.createElement("span", { className: "roi-label" }, "rPPG \xB7 forehead")), /* @__PURE__ */ React.createElement("div", { className: "vid-badge" }, session.id, " \xB7 analysis replay"), /* @__PURE__ */ React.createElement("div", { className: "vid-caption" }, f.roi ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "dot", style: { background: f.isFear ? "var(--danger)" : "var(--clear)" } }), f.isFear ? "Fear moment \u2014 score over threshold" : "Monitoring \u2014 no fear detected") : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "dot", style: { background: "var(--arousal)" } }), "Face lost \u2014 subject out of frame"))));
}
function PlayerTrace({ f, traces, D, playing, onSeek, onToggle, speed, setSpeed }) {
  ...
  const frac = f.t / D;
  return /* @__PURE__ */ React.createElement("div", { className: "ptrace" }, /* @__PURE__ */ React.createElement("div", { className: "ptrace-head" }, /* @__PURE__ */ React.createElement("span", { className: "ttl" }, "Fear score \xB7 drag anywhere to scrub"), /* @__PURE__ */ React.createElement("div", { className: "legend" }, /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { style: { background: "var(--ink-2)" } }), "F15 +heart"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { style: { background: "var(--ink-4)" } }), "F12 face"), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { style: { background: "var(--danger)", opacity: 0.5 } }), "fear window"))), /* @__PURE__ */ React.createElement(
    "div",
    {
...
function SessionRail({ sessions, sel, onSelect }) {
  return /* @__PURE__ */ React.createElement("div", { className: "session-rail" }, /* @__PURE__ */ React.createElement("div", { className: "rail-head" }, /* @__PURE__ */ React.createElement("span", { className: "rh-t" }, "Recorded sessions"), /* @__PURE__ */ React.createElement("span", { className: "rh-n" }, sessions.length, " clips \xB7 6 subjects \xB7 3 lighting conditions")), /* @__PURE__ */ React.createElement("div", { className: "session-list" }, sessions.map((s) => /* @__PURE__ */ React.createElement("button", { key: s.id, className: `s-card ${s.id === sel ? "sel" : ""}`, onClick: () => onSelect(s.id) }, /* @__PURE__ */ React.createElement("span", { className: "s-thumb" }, /* @__PURE__ */ React.createElement("img", { className: "s-thumb-img", src: `media/sessions/${s.id}/thumb.jpg`, alt: "", loading: "lazy" }), /* @__PURE__ */ React.createElement("span", { className: "play-ic" }, /* @__PURE__ */ React.createElement(Icon, { name: s.id === sel ? "pause" : "play", s: 15 })), /* @__PURE__ */ React.createElement("span", { className: "s-dur" }, mmss(s.dur))), /* @__PURE__ */ React.createElement("span", { className: "s-meta" }, /* @__PURE__ */ React.createElement("span", { className: "sm-top" }, /* @__PURE__ */ React.createElement("span", { className: "sm-id" }, s.subject), /* @__PURE__ */ React.createElement("span", { className: `lightchip ${s.lighting}` }, s.lighting), /* @__PURE__ */ React.createElement("span", { className: "sm-vid" }, s.vid)), /* @__PURE__ */ React.createElement("span", { className: "sm-sub" }, s.note))))), /* @__PURE__ */ React.createElement("div", { className: "note-strip" }, /* @__PURE__ */ React.createElement(Icon, { name: "info", s: 17 }), /* @__PURE__ */ React.createElement("span", null, "Each card streams its own real per-frame data + ", /* @__PURE__ */ React.createElement("span", { className: "mono" }, "raw_video.mp4"), ". The numbers match the offline HUD renderer exactly.")));
}
...
function TeachReadout({ c }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "teach-side" }, /* @__PURE__ */ React.createElement("div", { className: "ts-cap" }, "Signals this moment"), /* @__PURE__ */ React.createElement("div", { className: "teach-readout" }, /* @__PURE__ */ React.createElement(Row, { nm: "Fear (face)", val: c.fear, color: "var(--danger)" }), /* @__PURE__ */ React.createElement(Row, { nm: "Arousal", val: c.arousal, color: "var(--arousal)" }), /* @__PURE__ */ React.createElement(Row, { nm: "Facial tension", val: c.tension, color: "var(--tension)" }), /* @__PURE__ */ React.createElement(Row, { nm: "Heart-rate rise", val: c.bpmRise, color: "var(--heart)" }))), /* @__PURE__ */ React.createElement("div", { className: "teach-side" }, /* @__PURE__ */ React.createElement("div", { className: "ts-cap" }, "Two verdicts, two thresholds"), /* @__PURE__ */ React.createElement("div", { className: "teach-readout" }, /* @__PURE__ */ React.createElement(Row, { nm: "F12 \xB7 face only", val: r.F12, color: r.fear12 ? "var(--ink)" : "var(--ink-2)", thr: 0.7 }), /* @__PURE__ */ React.createElement(Row, { nm: "F15 \xB7 + heart rate", val: r.F15, color: r.fear15 ? "var(--danger)" : "var(--ink-2)", thr: 0.8 })), /* @__PURE__ */ React.createElement("div", { className: `teach-verdict ${r.fear15 ? "fear" : "clear"}` }, /* @__PURE__ */ React.createElement("div", { className: "tv-state" }, r.fear15 ? "FEAR DETECTED" : "NO FEAR"), /* @__PURE__ */ React.createElement("div", { className: "tv-why" }, c.f15Why))));
}
function FusionSection() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "section-block", id: "fusion" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "fuse-head-grid" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { className: "kicker reveal" }, "Fusion"), /* @__PURE__ */ React.createElement("h2", { className: "sec-title reveal" }, "Does the heartbeat help?"), /* @__PURE__ */ React.createElement("p", { className: "sec-lead reveal" }, "A fearful face can lie. Adding a contactless heart-rate read turns a face-only guess into a body-confirmed decision \u2014 a calm pulse holds back the", /* @__PURE__ */ React.createElement("b", { className: "mono", style: { color: "var(--ink)" } }, " F12 \u2265 0.70"), " face score, while a genuine cardiac response pushes the fused", /* @__PURE__ */ React.createElement("b", { className: "mono", style: { color: "var(--accent)" } }, " F15 over 0.80"), ".")), /* @__PURE__ */ React.createElement("div", { className: "fuse-formulas reveal" }, /* @__PURE__ */ React.createElement("div", { className: "fcard f12" }, /* @__PURE__ */ React.createElement("div", { className: "fc-top" }, /* @__PURE__ */ React.createElement("span", { className: "fc-tag" }, "F12"), /* @__PURE__ */ React.createElement("span", { className: "fc-name" }, "face only"), /* @__PURE__ */ React.createElement("span", { className: "fc-thr" }, "\u2265 0.70")), /* @__PURE__ */ React.createElement("div", { className: "fc-eq mono" }, /* @__PURE__ */ React.createElement(Eq, { parts: FUSE.f12.eq }))), /* @__PURE__ */ React.createElement("div", { className: "fcard f15" }, /* @__PURE__ */ React.createElement("div", { className: "fc-top" }, /* @__PURE__ */ React.createElement("span", { className: "fc-tag" }, "F15"), /* @__PURE__ */ React.createElement("span", { className: "fc-name" }, "+ heart rate"), /* @__PURE__ */ React.createElement("span", { className: "fc-thr" }, "\u2265 0.80")), /* @__PURE__ */ React.createElement("div", { className: "fc-eq mono" }, /* @__PURE__ */ React.createElement(Eq, { parts: FUSE.f15.eq, hr: true }))))), /* @__PURE__ */ React.createElement("div", { className: "teach reveal" }, /* @__PURE__ */ React.createElement("div", { className: "teach-tabs" }, TEACH.map((c, i) => /* @__PURE__ */ React.createElement("button", { key: c.key, className: `teach-tab ${i === ci ? "on" : ""}`, onClick: () => setCi(i) }, /* @__PURE__ */ React.createElement("div", { className: "tt-k" }, "Case ", i + 1), /* @__PURE__ */ React.createElement("div", { className: "tt-t" }, c.tab)))), /* @__PURE__ */ React.createElement("div", { className: "teach-body" }, /* @__PURE__ */ React.createElement(TeachReadout, { c: TEACH[ci] })))));
}
...
function Footer() {
  return /* @__PURE__ */ React.createElement("footer", { className: "footer", id: "about" }, /* @__PURE__ */ React.createElement("div", { className: "wrap footer-grid" }, /* @__PURE__ */ React.createElement("div", { className: "f-brand" }, /* @__PURE__ */ React.createElement("div", { className: "bt" }, "La Fa\xE7ade ", /* @__PURE__ */ React.createElement("em", null, "Fissur\xE9e")), /* @__PURE__ */ React.createElement("p", null, "Real-time emotion analysis for adaptive enemy AI in affective game design. A webcam-only, privacy-preserving approach to sensing fear \u2014 fusing facial emotion recognition with contactless heart rate.")), /* @__PURE__ */ React.createElement("div", { className: "f-col" }, /* @__PURE__ */ React.createElement("h4", null, "Project"), /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "Author"), "Ali Burak Sara\xE7"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "Advisor"), "Asst. Prof. Reis Burak Arslan"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "Date"), "May 2026"))), /* @__PURE__ */ React.createElement("div", { className: "f-col" }, /* @__PURE__ */ React.createElement("h4", null, "Institution"), /* @__PURE__ */ React.createElement("ul", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "University"), "Galatasaray University"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "Faculty"), "Engineering & Technology"), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("span", { className: "lab" }, "Department"), "Computer Engineering")))), /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("div", { className: "footer-base" }, /* @__PURE__ */ React.createElement("span", null, "HSEmotion \xB7 EfficientNet-B0"), /* @__PURE__ */ React.createElement("span", { className: "sep" }), /* @__PURE__ */ React.createElement("span", null, "MediaPipe FaceLandmarker"), /* @__PURE__ */ React.createElement("span", { className: "sep" }), /* @__PURE__ */ React.createElement("span", null, "Haar-first detection \xB7 CLAHE"), /* @__PURE__ */ React.createElement("span", { className: "sep" }), /* @__PURE__ */ React.createElement("span", null, "rPPG \xB7 POS @ 30 s"))));
}
function SectionCustomizer({ open, onClose, sections, order, hidden, move, toggle, reset, onJump }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "cust-scrim", onClick: onClose }), /* @__PURE__ */ React.createElement("aside", { className: "cust", role: "dialog", "aria-label": "Customize sections" }, /* @__PURE__ */ React.createElement("div", { className: "cust-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "cust-t" }, "Customize this page"), /* @__PURE__ */ React.createElement("div", { className: "cust-s" }, visibleCount, " of ", sections.length, " sections shown \xB7 saved on this device")), /* @__PURE__ */ React.createElement("button", { className: "cust-x", onClick: onClose, "aria-label": "Close" }, /* @__PURE__ */ React.createElement(Icon, { name: "close", s: 16 }))), /* @__PURE__ */ React.createElement("div", { className: "cust-list" }, ordered.map((s, i) => {
    const off = !!hidden[s.id];
    const locked = s.locked;
    return /* @__PURE__ */ React.createElement("div", { className: `cust-row ${off ? "off" : ""}`, key: s.id }, /* @__PURE__ */ React.createElement("span", { className: "cust-grip" }, /* @__PURE__ */ React.createElement(Icon, { name: "dot6", s: 16 })), /* @__PURE__ */ React.createElement("button", { className: "cust-name", onClick: () => !off && onJump(s.id), disabled: off, title: off ? "Hidden" : "Jump to section" }, /* @__PURE__ */ React.createElement("span", { className: "cn-i" }, String(i + 1).padStart(2, "0")), s.label, locked ? /* @__PURE__ */ React.createElement("span", { className: "cn-lock" }, "always on") : null), /* @__PURE__ */ React.createElement("span", { className: "cust-acts" }, /* @__PURE__ */ React.createElement("button", { onClick: () => move(s.id, -1), disabled: i === 0, "aria-label": "Move up" }, /* @__PURE__ */ React.createElement(Icon, { name: "up", s: 14 })), /* @__PURE__ */ React.createElement("button", { onClick: () => move(s.id, 1), disabled: i === ordered.length - 1, "aria-label": "Move down" }, /* @__PURE__ */ React.createElement(Icon, { name: "down", s: 14 })), /* @__PURE__ */ React.createElement("label", { className: `cust-eye ${locked ? "locked" : ""}`, title: locked ? "This section can't be hidden" : off ? "Show" : "Hide" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: !off, disabled: locked, onChange: () => toggle(s.id) }), /* @__PURE__ */ React.createElement("span", { className: "track" }, /* @__PURE__ */ React.createElement("span", { className: "knob" })))));
  })), /* @__PURE__ */ React.createElement("div", { className: "cust-foot" }, /* @__PURE__ */ React.createElement("button", { className: "cust-reset", onClick: reset }, /* @__PURE__ */ React.createElement(Icon, { name: "reset", s: 14 }), " Reset to default"), /* @__PURE__ */ React.createElement("span", { className: "cust-hint" }, "Reorder with \u2191\u2193 \xB7 toggle to hide"))));
}
