...
const LIT = [
  ...
  { ic: "shield", t: "Biofeedback & privacy", refs: [
    ...
    { c: "Guti\xE9rrez et al.", y: "2025", d: "Federated learning + AES-256 hits 87% \u2014 privacy and accuracy aren't exclusive. <b>Validates fully local processing.</b>" }
  ] }
];
const GAPS = [
...
function BackgroundSection() {
  return /* @__PURE__ */ React.createElement("section", { className: "section-block divline", id: "background" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("span", { className: "kicker reveal" }, "Background"), /* @__PURE__ */ React.createElement("h2", { className: "sec-title reveal" }, "What the literature already knew \u2014 and didn't"), /* @__PURE__ */ React.createElement("p", { className: "sec-lead reveal" }, "The review follows the pipeline's own logic: facial emotion recognition, remote photoplethysmography, multimodal fusion, biofeedback, and privacy. Each result below shaped a concrete design decision."), /* @__PURE__ */ React.createElement("div", { className: "lit-grid" }, LIT.map((g) => /* @__PURE__ */ React.createElement("div", { className: "lit-card reveal", key: g.t }, /* @__PURE__ */ React.createElement("div", { className: "lc-h" }, /* @__PURE__ */ React.createElement("span", { className: "lc-ic" }, /* @__PURE__ */ React.createElement(SiteIcon, { name: g.ic, s: 18 })), /* @__PURE__ */ React.createElement("span", { className: "lc-t" }, g.t)), /* @__PURE__ */ React.createElement("div", { className: "lit-refs" }, g.refs.map((r) => /* @__PURE__ */ React.createElement("div", { className: "lref", key: r.c }, /* @__PURE__ */ React.createElement("span", { className: "lr-cite" }, r.c, /* @__PURE__ */ React.createElement("small", null, r.y)), /* @__PURE__ */ React.createElement("span", { className: "lr-d", dangerouslySetInnerHTML: { __html: r.d } }))))))), /* @__PURE__ */ React.createElement("span", { className: "kicker k-plain reveal", style: { color: "var(--ink-4)", marginTop: "clamp(40px,6vw,64px)", display: "inline-flex" } }, "Four cumulative gaps"), /* @__PURE__ */ React.createElement("div", { className: "gaps" }, GAPS.map((g) => /* @__PURE__ */ React.createElement("div", { className: "gap reveal", key: g.n }, /* @__PURE__ */ React.createElement("div", { className: "gp-n" }, g.n), /* @__PURE__ */ React.createElement("div", { className: "gp-t" }, g.t), /* @__PURE__ */ React.createElement("div", { className: "gp-d" }, g.d)))), /* @__PURE__ */ React.createElement("div", { className: "swot" }, [["s", "Strengths", SWOT.s], ["w", "Weaknesses", SWOT.w], ["o", "Opportunities", SWOT.o], ["t", "Threats", SWOT.t]].map(([k, lab, items]) => /* @__PURE__ */ React.createElement("div", { className: `swot-q ${k} reveal`, key: k }, /* @__PURE__ */ React.createElement("div", { className: "sq-h" }, lab), /* @__PURE__ */ React.createElement("ul", null, items.map((it, i) => /* @__PURE__ */ React.createElement("li", { key: i }, it)))))), /* @__PURE__ */ React.createElement("div", { className: "swot-note reveal" }, /* @__PURE__ */ React.createElement("b", null, "Retrospective:"), " the hardware failure turned the \u201Csmall sample\u201D weakness and the \u201Crecruitment\u201D threat into a video-based evaluation that ultimately produced a more diverse subject pool.")));
}
const LAT = [
...
function PerformanceSection() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "section-block divline", id: "performance" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("span", { className: "kicker reveal" }, "Performance & cost"), /* @__PURE__ */ React.createElement("h2", { className: "sec-title reveal" }, "~53 ms, end to end, on a consumer laptop"), /* @__PURE__ */ React.createElement("p", { className: "sec-lead reveal" }, "The latency budget (measured on a 197 s session at 30 FPS) sits well inside the 100 ms real-time target. The camera's own frame period is the largest single cost; with pipelined capture the effective throughput reaches 27\u201330 FPS."), /* @__PURE__ */ React.createElement("div", { className: "lat-wrap", ref }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "lat-bar" }, LAT.map((r) => /* @__PURE__ */ React.createElement("div", { className: "lat-row", key: r.nm }, /* @__PURE__ */ React.createElement("span", { className: "lr-nm" }, r.nm), /* @__PURE__ */ React.createElement("span", { className: "lr-track" }, /* @__PURE__ */ React.createElement("span", { className: "lr-fill", style: { width: seen ? `${r.ms / max * 100}%` : 0, background: col(r.ms) } })), /* @__PURE__ */ React.createElement("span", { className: "lr-ms" }, r.ms < 1 ? "<1" : r.ms)))), /* @__PURE__ */ React.createElement("div", { className: "lat-total" }, /* @__PURE__ */ React.createElement("span", { className: "lt-v" }, "53", /* @__PURE__ */ React.createElement("span", { style: { fontSize: "0.5em", color: "var(--ink-3)" } }, "ms")), /* @__PURE__ */ React.createElement("span", { className: "lt-k" }, "total per-frame latency \xB7 ~19 FPS (27\u201330 pipelined)"), /* @__PURE__ */ React.createElement("span", { className: "lt-budget" }, "budget: <100 ms \u2713"))), /* @__PURE__ */ React.createElement("div", { className: "lat-side" }, /* @__PURE__ */ React.createElement("h4", null, "CPU utilization"), /* @__PURE__ */ React.createElement("div", { className: "ls-row" }, /* @__PURE__ */ React.createElement("span", { className: "ls-k" }, "MediaPipe (C++ runtime)"), /* @__PURE__ */ React.createElement("span", { className: "ls-v" }, "4%")), /* @__PURE__ */ React.createElement("div", { className: "ls-row" }, /* @__PURE__ */ React.createElement("span", { className: "ls-k" }, "HSEmotion (PyTorch, CPU)"), /* @__PURE__ */ React.createElement("span", { className: "ls-v" }, "67.5%")), /* @__PURE__ */ React.createElement("div", { className: "ls-note" }, "No CUDA under Windows during offline processing. The rPPG pipeline runs on a non-blocking background thread \u2014 ROI extraction ~1 ms/frame, FFT every 3 s.")))));
}
const CONTRIB = [
...
function OutlookSection() {
  return /* @__PURE__ */ React.createElement("section", { className: "section-block divline", id: "outlook" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("span", { className: "kicker reveal" }, "Contributions & outlook"), /* @__PURE__ */ React.createElement("h2", { className: "sec-title reveal" }, "What it proved, and what's next"), /* @__PURE__ */ React.createElement("div", { className: "outlook-grid" }, /* @__PURE__ */ React.createElement("div", { className: "ol-col contrib reveal" }, /* @__PURE__ */ React.createElement("h3", null, /* @__PURE__ */ React.createElement("span", { className: "ol-ic" }, /* @__PURE__ */ React.createElement(SiteIcon, { name: "shield", s: 17 })), "Contributions"), /* @__PURE__ */ React.createElement("div", { className: "ol-list" }, CONTRIB.map((c, i) => /* @__PURE__ */ React.createElement("div", { className: "ol-item", key: i }, /* @__PURE__ */ React.createElement("span", { className: "oi-n" }, String(i + 1).padStart(2, "0")), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "oi-t" }, c.t), /* @__PURE__ */ React.createElement("span", { className: "oi-d" }, c.d)))))), /* @__PURE__ */ React.createElement("div", { className: "ol-col limit reveal" }, /* @__PURE__ */ React.createElement("h3", null, /* @__PURE__ */ React.createElement("span", { className: "ol-ic" }, /* @__PURE__ */ React.createElement(SiteIcon, { name: "info", s: 17 })), "Limitations"), /* @__PURE__ */ React.createElement("div", { className: "ol-list" }, LIMITS.map((c, i) => /* @__PURE__ */ React.createElement("div", { className: "ol-item", key: i }, /* @__PURE__ */ React.createElement("span", { className: "oi-n" }, String(i + 1).padStart(2, "0")), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("span", { className: "oi-t" }, c.t), /* @__PURE__ */ React.createElement("span", { className: "oi-d" }, c.d))))))), /* @__PURE__ */ React.createElement("div", { className: "future reveal" }, /* @__PURE__ */ React.createElement("span", { className: "kicker k-plain", style: { color: "var(--ink-4)" } }, "Future work \u2014 three axes"), /* @__PURE__ */ React.createElement("div", { className: "future-grid" }, FUTURE.map((f) => /* @__PURE__ */ React.createElement("div", { className: "fut", key: f.t }, /* @__PURE__ */ React.createElement("div", { className: "ft-t" }, f.t), /* @__PURE__ */ React.createElement("div", { className: "ft-d" }, f.d))))), /* @__PURE__ */ React.createElement("div", { className: "conclusion reveal" }, /* @__PURE__ */ React.createElement("div", { className: "cc-k" }, "Conclusion"), /* @__PURE__ */ React.createElement("div", { className: "cc-t" }, "The technical barrier to affective gaming is ", /* @__PURE__ */ React.createElement("em", null, "no longer the hardware.")), /* @__PURE__ */ React.createElement("div", { className: "cc-d" }, "A standard webcam, two open-source models and a composite formula running in 53 ms on a consumer laptop are enough to sense fear. What remains is evaluation methodology, cross-subject calibration, and the closed-loop validation that a live gameplay experiment will provide."))));
}
const GLOSS = [
  {
    t: "rPPG",
    ab: "remote photoplethysmography",
  ...
  {
    t: "CLAHE",
    ab: "adaptive histogram equalization",
    ...
    tech: "Contrast-Limited Adaptive Histogram Equalization on the L channel (clipLimit 2.0, 4\xD74 tiles) \u2014 local equalization with contrast clipping to avoid noise amplification."
  },
  {
    t: "FER",
    ab: "facial emotion recognition",
...
function GlossarySection() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "section-block divline", id: "glossary" }, /* @__PURE__ */ React.createElement("div", { className: "wrap" }, /* @__PURE__ */ React.createElement("span", { className: "kicker reveal" }, "Glossary"), /* @__PURE__ */ React.createElement("h2", { className: "sec-title reveal" }, "Every term, two ways"), /* @__PURE__ */ React.createElement("div", { className: "gloss-head reveal" }, /* @__PURE__ */ React.createElement("p", { className: "sec-lead", style: { marginTop: 0, flex: "1 1 320px" } }, "The same plain \u2194 technical switch the HUD uses, applied to the vocabulary of the report."), /* @__PURE__ */ React.createElement("div", { className: "gloss-toggle" }, /* @__PURE__ */ React.createElement("button", { className: mode === "plain" ? "on" : "", onClick: () => setMode("plain") }, "Plain language"), /* @__PURE__ */ React.createElement("button", { className: mode === "tech" ? "on" : "", onClick: () => setMode("tech") }, "Technical"))), /* @__PURE__ */ React.createElement("div", { className: "gloss-grid" }, GLOSS.map((g) => /* @__PURE__ */ React.createElement("div", { className: "gterm", key: g.t }, /* @__PURE__ */ React.createElement("div", { className: "gt-h" }, /* @__PURE__ */ React.createElement("span", { className: "gt-t" }, g.t), /* @__PURE__ */ React.createElement("span", { className: "gt-ab" }, g.ab)), /* @__PURE__ */ React.createElement("div", { className: `gt-d ${mode === "tech" ? "tech" : ""}` }, mode === "tech" ? g.tech : g.plain))))));
}
